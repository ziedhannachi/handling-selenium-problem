...
public class QRCodeTest {
	...
	void readQRCodeFromBase64() {
		...
		/*
		 * Split the content of src attribute from qr-base64 image to get only the
		 * Base64 String Because the src starts with 'data:image/png;base64,' and the
		 * following text is the Base64 String
		 */
